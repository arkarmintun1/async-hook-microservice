...
export default class AmqpService {
  ...
  /**
   * Initialize the service and connect the message queue.
   * `connection` and `channel` values are set after calling this function.
   * @returns promise for queue connection
   */
  public init() {
